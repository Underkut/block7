...
global.APP_VERSION = 'v. 26-0812-10';
...
{
  sc.eq('같으면 0', _verCmp('v. 26-0812-10', 'v. 26-0812-10'), 0);
  ...
  sc.eq('못 읽으면 판단하지 않는다', _verCmp('알 수 없음', 'v. 26-0812-10'), null);

  sc.eq('낮은 버전이 쓴 문서', _fbVerIsOlder('v. 26-0807-4'), true);
  sc.eq('같은 버전은 낡지 않았다', _fbVerIsOlder('v. 26-0812-10'), false);
  sc.eq('더 새 버전도 낡지 않았다', _fbVerIsOlder('v. 26-0812-10'), false);
